import { ArrowRight, Github, Linkedin, Mail, Sparkles, Code, Cpu, Globe } from "lucide-react";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left relative z-10 order-2 lg:order-1">
                        ...
                        <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-lg mx-auto lg:mx-0 animate-slide-up animation-delay-200">
                            A creative <span className="font-semibold text-gray-900">Software Engineer</span> building elegant, scalable solutions for the web and AI.
                        </p>
                    ...
                    <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end animate-fade-in my-8 lg:my-0">
                        ...
                        <div className="relative z-10 scale-90 sm:scale-100">
                            ...
                            <div className="absolute top-1/2 -left-8 lg:-left-16 bg-white px-5 py-3 rounded-full shadow-lg flex items-center gap-2 animate-float-delayed z-20">
                                ...
                                <span className="font-bold text-sm text-gray-800">Open to work</span>
                            </div>
                            ...
                            <div className="absolute -bottom-6 -right-2 lg:-bottom-10 lg:right-6 bg-white/95 backdrop-blur-sm p-4 rounded-2xl shadow-xl border border-blue-50 animate-float z-20">
                                <div className="flex items-center gap-4">
                                    <div className="flex -space-x-4">
                                        {/* Angular */}
                                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border-2 border-white shadow-sm p-1.5 transition-transform hover:scale-110 hover:z-10 cursor-pointer" title="Angular">
                                            <SiAngular className="w-full h-full text-[#DD0031]" />
                                        </div>
                                        {/* React */}
                                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border-2 border-white shadow-sm p-1.5 transition-transform hover:scale-110 hover:z-10 cursor-pointer" title="React">
                                            <SiReact className="w-full h-full text-[#61DAFB]" />
                                        </div>
                                        {/* MongoDB */}
                                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border-2 border-white shadow-sm p-1.5 transition-transform hover:scale-110 hover:z-10 cursor-pointer" title="MongoDB">
                                            <SiMongodb className="w-full h-full text-[#47A248]" />
                                        </div>
                                        {/* Docker */}
                                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border-2 border-white shadow-sm p-1.5 transition-transform hover:scale-110 hover:z-10 cursor-pointer" title="Docker">
                                            <SiDocker className="w-full h-full text-[#2496ED]" />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="text-[10px] uppercase tracking-wider text-gray-500 font-semibold">Tech Stack</div>
                                        <div className="text-sm font-bold text-gray-800">MERN + Docker</div>
                                    </div>
                                </div>
                            </div>
                        </div>
