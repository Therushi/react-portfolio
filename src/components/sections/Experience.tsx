...
const experiences = [
    {
        ...
        description: "Engineered a data reporting pipeline using MySQL stored procedures, reducing reporting time from 40+ hours to minutes. Developed a backend system automating survey life-cycles for 20+ clients, saving 50+ hours of manual work monthly. Optimized APIs using MongoDB aggregations (60% faster) and implemented a 'magic link' login system boosting response rates by 30%.",
        skills: ["Node.js", "MongoDB", "MySQL", "AWS"],
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-20 animate-fade-in">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        A timeline of my professional growth and the impactful projects I've been a part of.
                    </p>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="space-y-12 lg:space-y-24">
                        {experiences.map((exp, index) => (
                            <div key={exp.id} className={`relative flex flex-col lg:flex-row items-start ${index % 2 === 0 ? 'lg:flex-row-reverse' : ''} gap-8 lg:gap-0 group`}>
                                ...
                                <div className={`hidden lg:flex absolute left-1/2 -translate-x-1/2 mt-4 bg-white px-4 py-1 rounded-full border border-gray-100 shadow-sm text-sm font-medium text-gray-500 z-10 group-hover:border-blue-200 group-hover:text-blue-600 transition-colors`}>
                                    {exp.date}
                                </div>

                                {/* Content Card */}
                                <div className={`w-full lg:w-[calc(50%-3rem)] ml-12 lg:ml-0 px-4 md:px-0`}>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className={`absolute -top-10 -right-10 w-32 h-32 rounded-full opacity-20 blur-2xl ${exp.shadow.replace('shadow-', 'bg-')}`} />
